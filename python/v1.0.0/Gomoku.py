...
class game():
    def __init__(self, screen_long=800):
        ...
        self.history = []
        self.click_num = 0
        self.update_params(screen_long)
        ...
        while running:
            ...
            for cx, cy in star_points:
                pygame.draw.circle(
                    self.screen,
                    "#000000",
                    (int(self.margin + self.line_spacing * cx), int(self.margin + self.line_spacing * cy)),
            ...
            if 0 <= (grid_x - self.margin) / self.line_spacing < 15 and 0 <= (grid_y - self.margin) / self.line_spacing < 15:
                ...
                pygame.draw.rect(
                    self.screen,
                    next_color,
                    [grid_x - self.line_spacing / 2, grid_y - self.line_spacing / 2, self.line_spacing, self.line_spacing],
                    3
                )
